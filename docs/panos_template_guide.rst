...
----------------------------------------------------------------------
    ...
    Starting with IronSkillet 10.1, the xml snippets are included in sub-skillets in the ironskillet-components
    ...
    See the Playlist Includes tutorial on SkilletBuilder for more information on how this works.
